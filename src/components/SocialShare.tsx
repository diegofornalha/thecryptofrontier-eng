...
const SocialShare: React.FC<SocialShareProps> = ({ url, title, className = '' }) => {
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      <span className="text-sm font-medium text-[#666] mr-2">Compartilhar:</span>
      ...
      <button
        ...
        className="w-9 h-9 rounded-full bg-[#0088cc] flex items-center justify-center hover:opacity-80 transition-opacity"
