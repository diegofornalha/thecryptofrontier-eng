...
const socialLinks = [
  {
    name: 'Twitter',
    url: 'https://twitter.com/alexbianchixfx',
    icon: (
  ...
  {
    name: 'Instagram',
    url: 'https://instagram.com/alexandrebianchioficial/',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Telegram',
    url: 'https://t.me/alexandrebianchitraderoficial',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'YouTube',
    url: 'https://youtube.com/@alexandrebianchioficial',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
